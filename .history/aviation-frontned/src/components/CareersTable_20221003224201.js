      ...
      .then((response) => {
        setJobs(
          response.data.map((item) => {
            ...
            return {
              JobTitle: item.contractAddress,
              CompanyName: item.contractAddress,
              Location: item.contractAddress,
              Description: item.contractAddress,
              Requirements: item.contractAddress,
              Salary: item.contractAddress,
              Other: item.contractAddress,
            };
          })
        );
      })
