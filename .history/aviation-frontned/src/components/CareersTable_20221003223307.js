        ...
        setJobs(
          response.data.map((item) => {
            ...
            return {
              ...
              Requirements: item.jobTitle,
              Salary: item.jobTitle,
              Other: item.jobTitle,
            };
          })
        );
                ...
                <div>
                  <td className="row">
                    ...
                    <td style={{ color: "gray" }}>
                      ...
                      your ambition higher than ever before. With a career that
                      takes you places, it’s all about enjoying the boundless
                      opportunities and experiences you can set for yourself. If
                      you have an outgoing, warm, friendly personality and hold
                      a strong passion for delighting and creating memorable
                      customer experiences while travelling around the world, we
                      invite you to join our Flight Attendant Recruitment Day on
                      7-8 October 2022 at Cordis Hotel, Mongkok. Register for a
                      timeslot now! Shortlisted candidate will receive a special
                      gift and timeslots will be distributed on a
                      first-come-first-served basis. We will also reserve a
                      limited number of interview slots for walk-in candidates
                      on 8 October from 2:30 PM to 4:30 PM.
                    </td>
                  </td>
                  <td>
                    Requirements
                    <ul style={{ color: "gray" }}>
                      <li>
                        Completing all line and base maintenance tasks in a safe
                  ...
                  <td className="row">The package available is as follows:</td>
                  <td className="row">€28 per hour *(NET)* </td>
                  <td className="row">Up to 60 hours per week Accommodation</td>
